...
export const env = {
  ...
  JWT_REGISTER_SECRET: process.env.JWT_REGISTER_SECRET,
  JWT_REGISTER_EXPIRES_IN: process.env.JWT_REGISTER_EXPIRES_IN || '15m', // Added so the program actually uses the specified time in the env file, if its not there just default to 15m
